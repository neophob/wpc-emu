 ...
 *                                                                          *
 ****************************************************************************/
void M6809TFREXG(REGS6809 *regs, unsigned char ucPostByte, unsigned short *PC, BOOL bExchange)
{
      ...
      *iClocks -= c6809Cycles[ucOpcode]; /* Subtract execution time */
      switch (ucOpcode)
         ...
         case 0x1E: /* EXG */
            ...
            M6809TFREXG(regs, ucTemp, &PC, TRUE);
            break;

         case 0x1F: /* TFR */
            ucTemp = M6809ReadByte(m_map09, PC++); /* Get postbyte */
            M6809TFREXG(regs, ucTemp, &PC, FALSE);
            break;
