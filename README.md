...
### Implementation
The soundboard works independent from the main board and the communication between the CPU board and Sound board is rater simple, just a 16 bit command is send to the sound board, then the sound board will play that specific number.
