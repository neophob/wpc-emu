  ...
  write(data) {
    ...
    if (this.codeW > 0) {
      if (this.unlockCode[3 - this.codeW] !== data) {
        debug('Wrong code sent to pic', { sent: data, codeW: this.codeW, expected: this.unlockCode[3 - this.codeW] });
      } else {
        debug('Correct code sent to pic', { sent: data, codeW: this.codeW, expected: this.unlockCode[3 - this.codeW] });
      }
      this.codeW--;
      return;
    }
