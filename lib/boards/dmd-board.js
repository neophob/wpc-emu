...
class DMD {
  ...
  copyScanline() {
    ...
    const magicScanline = parseInt(this.ram[OP.WPC_DMD_SCANLINE] * 4 / 32, 10);
    //TODO WHITE WATER FLICKERS
    if ((this.scanline % 4) === magicScanline && this.scanline > 0 && this.scanline < 31) {
  ...
  read(offset) {
    ...
    switch (offset) {
      ...
      case OP.WPC_DMD_SCANLINE:
        ...
        console.log('WPC_DMD_SCANLINE',this.ram[offset]);
