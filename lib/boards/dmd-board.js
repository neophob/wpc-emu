...
class DMD {
  ...
  constructor(initObject) {
    ...
    this.videoRam = new Uint8Array(DMD_RAM_REGIONS * DMD_PAGE_SIZE * DMD_NR_OF_PAGES).fill(0);
  }
  ...
  write(offset, value) {
    ...
    if (offset < DMD_START_PAGE_1_ADDRESS) {
      console.log('OHA123',offset, value)
    }
