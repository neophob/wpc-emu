...
class OutputAlphaDisplay {
  ...
  _drawChar(buffer, offset, value) {
    ...
    if (value & SEG_VERT_BOT) {
      buffer[OFFSET_MIDDLE + offset + 2] = 3;
      buffer[OFFSET_MIDDLE + offset + 2 + 1 * OFFSET_LINE] = 3;
      buffer[OFFSET_MIDDLE + offset + 2 + 2 * OFFSET_LINE] = 3;
      buffer[OFFSET_MIDDLE + offset + 2 + 3 * OFFSET_LINE] = 3;
      buffer[OFFSET_MIDDLE + offset + 2 + 4 * OFFSET_LINE] = 3;
      buffer[OFFSET_MIDDLE + offset + 2 + 5 * OFFSET_LINE] = 3;
    }
