...
const DCS_UNKNOWN_COIN_DOOR_OPEN_SOUND = 0x3D8;
...
class SoundInterface {
  ...
  _processDcsSoundCommand() {
    ...
    switch (sampleId) {
      ...
      // When the coin door opens during game, this command is sent to the sound board
      case DCS_UNKNOWN_COIN_DOOR_OPEN_SOUND:
        console.log('DCS_UNKNOWN_COIN_DOOR_OPEN?');
        break;

      case DCS_GET_MAIN_VERSION:
      case DCS_GET_MINOR_VERSION:
        console.log('DCS_GETVERSION_NOT_IMPLEMENTED!');
        break;
