...
class SecurityPIC {
  ...
  read(getActiveRowFunction) {
      ...
      case this._readPicSerial(15):
        ...
        if (offset < 0 || offset > this.serialNumber) {
          console.log('invalid OFFSET!!!', offset);
          return 0;
        }
				return this.serialNumber[offset];
  ...
  write(data) {
    ...
    if (this.unlockMode > 0) {
      ...
      console.log('this.unlockCode',this.unlockCode);
      ...
      console.log('pic unlocked', this.writesUntilUnlockNeeded);
			this.unlockMode = 1;
			this.unlockCode = 0;
      this.writesUntilUnlockNeeded = 0xFF;
      return;
