...
class OutputSolenoidMatrix {
  ...
  writeFliptronic(value) {
    debug('UPDATE_FLIPTRONIC_FLIPPER_SOLENOIDS');
    // we might need to know if we should write to WPC_FLIPTRONIC_PORT_A or WPC95_FLIPPER_COIL_OUTPUT
    return this._updateSolenoidsPacked(OFFSET_SOLENOID_FLIPTRONIC, value);
  }
