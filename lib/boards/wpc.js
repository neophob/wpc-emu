...
function getInstance(romSizeMBit) {
  return new WpcIo(romSizeMBit);
}

/*
wpcemu:boards:wpc W_NOT_IMPLEMENTED 0x3fe0 0 +0ms WPC_SOL_GEN_OUTPUT
wpcemu:boards:wpc W_NOT_IMPLEMENTED 0x3fe1 0 +0ms WPC_SOL_HIGHPOWER_OUTPUT
wpcemu:boards:wpc W_NOT_IMPLEMENTED 0x3fe2 0 +1ms WPC_SOL_FLASH1_OUTPUT
wpcemu:boards:wpc W_NOT_IMPLEMENTED 0x3fe3 0 +0ms WPC_SOL_LOWPOWER_OUTPUT
wpcemu:boards:wpc W_NOT_IMPLEMENTED 0x3fe6 0 +0ms WPC_GI_TRIAC
...
class WpcIo {
  constructor(romSizeMBit) {
    this.pageMask = PAGESIZE_MAP[romSizeMBit];
    debug('pageMask', this.pageMask, romSizeMBit);
    this.romBank = 0;
