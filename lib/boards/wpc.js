  ...
  read(offset) {
    ...
    switch (offset) {
      ...
      case OP.WPC_SHIFTBIT2:
        ...
        return 1 << (this.genericState[OP.WPC_SHIFTBIT2] & 0x07);
      ...
      case OP.WPC_ZEROCROSS_IRQ_CLEAR:
        temp = this.zeroCrossFlag << 7 | (this.genericState[OP.WPC_ZEROCROSS_IRQ_CLEAR] & 0x7F);
