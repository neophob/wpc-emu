...
class DisplayBoard {
  ...
  constructor(initObject) {
    ...
    this.outputDmdDisplay = outputDmdDisplay.getInstance();
    this.outputAlphaDisplay = outputAlphaDisplay.getInstance(0x200);
  }
  ...
  write(offset, value) {
    ...
    switch (offset) {
      ...
      case OP.WPC_DMD_ACTIVE_PAGE:
        ...
        this.outputDmdDisplay.nextActivePage = value & 0xF;
        break;
