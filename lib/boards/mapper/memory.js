...
function getAddress(offset) {
  ...
  if (isRam2Region || offset < MEMORY_ADDR_RAM) {
  ...
  if (offset < MEMORY_ADDR_SYSTEMROM) {
    return buildReturnModel(offset - 0x8000, SUBSYSTEM_SYSTEMROM);
  }
...
$0000-$1FFF (8 KiB)	RAM
            ...
            $1800     Byte     Time checksum??? unclear 9 bytes, 2 of it checksum?
...
$2000-$3FFF (8 KiB)	Hardware
            ...
            $3C00-$3FAF	    ??? Expansion -- TODO mame define this as RAM?
                            Address	  Format	 Description
