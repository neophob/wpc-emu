...
const DMD_PAGE_1_MAXIMAL_ADDRESS = 0x3A00;
const DMD_PAGE_2_MAXIMAL_ADDRESS = 0x3FBC;
...
class DMD {
  ...
  write(offset, value) {
    ...
    if (offset < DMD_PAGE_1_MAXIMAL_ADDRESS) {
      debug('WRITE DMD_PAGE_1_MAXIMAL_ADDRESS', value);
      return;
    }
    if (offset < DMD_PAGE_2_MAXIMAL_ADDRESS) {
