...
class DMD {
  ...
  getUiState() {
    const buffer = Buffer.from(this.genericState);
    const page1 = new Uint8Array(buffer, DMD_PAGE1_START, DMD_PAGE_SIZE);
    const page2 = new Uint8Array(buffer, DMD_PAGE2_START, DMD_PAGE_SIZE);
