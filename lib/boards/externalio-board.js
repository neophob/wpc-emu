...
const InputFliptronics = require('./elements/input-fliptronics');
...
class ExternalIo {
  ...
  constructor() {
    ...
    this.fliptronics = InputFliptronics.getInstance();
  }

  setFliptronicsInput(value) {
    this.fliptronics.setInput(value);
  }
  ...
  write(offset, value) {
    ...
    switch (offset) {
      ...
      case OP.WPC_FLIPTRONICS_FLIPPER_PORT_A:
        //console.log('WRITE_FLIPTRONICS', value);
        break;
  ...
  read(offset) {
    ...
    switch (offset) {
      ...
      case OP.WPC_FLIPTRONICS_FLIPPER_PORT_A:
        //console.log('READ FLIPTRONICS', this.ram[_offset]);
        break;
