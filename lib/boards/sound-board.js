  ...
  _hardwareRead(offset) {
    switch (offset) {
      ...
      case soundMapper.ADDRESS_WPC_LATCH_READ:
        ...
        console.log('ADDRESS_WPC_LATCH_READ');
  ...
  readInterface(offset) {
    switch (offset) {
      case OP.WPC_SOUND_CONTROL_STATUS:
        ...
        //TODO return sndbrd_0_data_r(0); - set firq source audio
        return this._hardwareRead(soundMapper.ADDRESS_YM2151_REGISTER);

      case OP.WPC_SOUND_DATA:
        debug('READ', REVERSEOP[offset]);
        console.log('READ', REVERSEOP[offset]);
        return this._hardwareRead(soundMapper.ADDRESS_YM2151_DATA);
