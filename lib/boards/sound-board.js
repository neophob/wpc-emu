  ...
  _hardwareWrite(offset, value) {
    switch (offset) {
      ...
      case OP.WPC_VOLUME_WRITE:
        ...
        debug('WRITE WPC_VOLUME_WRITE %o', { value });
        console.log('WRITE WPC_VOLUME_WRITE %o', { value });
        break;

      case OP.WPC_LATCH_WRITE:
        debug('WRITE WPC_LATCH_WRITE', value);
        this.writeBytes++;
        this.soundSerialInterface.write(value);
        break;
  ...
  _hardwareRead(offset) {
    switch (offset) {
      ...
      case OP.WPC_LATCH_READ:
        const value = this.soundSerialInterface.read();
