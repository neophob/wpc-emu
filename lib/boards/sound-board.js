...
class SoundBoard {
  ...
  constructor(initObject) {
    ...
    if (!this.systemROM || !this.concatinatedSoundRom) {
...
/*      this.firqHackTicks += singleTicks;
  ...
  _cpuWrite8(offset, value) {
    ...
    switch (address.subsystem) {
      ...
      case soundMapper.SUBSYSTEM_BANKSWITCHED:
      /*
      SUBSYSTEM_BANKSWITCHED__SND_INVALID_WRITE_SUBSYSTEM_0x 4e9c 81
      SUBSYSTEM_BANKSWITCHED__SND_INVALID_WRITE_SUBSYSTEM_0x 5151 78
      SUBSYSTEM_BANKSWITCHED__SND_INVALID_WRITE_SUBSYSTEM_0x 5152 154
      */
/*        console.log('SUBSYSTEM_BANKSWITCHED__SND_INVALID_WRITE_SUBSYSTEM',
          '0x' + offset.toString(16),
          '0x' + address.offset.toString(16),
        value);*/
        break;

      case soundMapper.SUBSYSTEM_ROM:
        /*if (address.offset >= 0x3800 && address.offset <= 0x3BFF) {
          // { 0x3800, 0x3800, wpcs_volume_w }, // 3800-3bff
          //console.log('??set volume', value);
          return;
        }
        if (address.offset >= 0x3C00 && address.offset <= 0x3FFF) {
...
/*        console.log('SUBSYSTEM_ROM__SND_INVALID_WRITE_SUBSYSTEM',
          '0x' + offset.toString(16),
          '0x' + address.offset.toString(16),
          value);*/
        break;
      ...
      default:
        console.log('wpcemu:boards:sound-board: CPU_WRITE8_FAIL', JSON.stringify(address), offset, value);
  ...
  readInterface(offset) {
    switch (offset) {
      ...
      default:
        ...
        debug('SND_R_NOT_IMPLEMENTED', '0x' + offset.toString(16), this.ram[offset]);
