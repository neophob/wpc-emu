...
/*      this.firqHackTicks += singleTicks;
  ...
  _getBankRomOffset(value) {
    ...
    switch ((~value) & 0xE0) {
      ...
      default:
        ...
        console.log('UNKNOWN_SOUND_ROM_BANK_' + value);
    }
    return bankBase << 15;
  }
  ...
  _hardwareWrite(offset, value) {
    switch (offset) {
      ...
      case soundMapper.ADDRESS_YM2151_DATA:
       ...
       /*if (this.ym2151Register0===20)console.log('WRITE ADDRESS_YM2151_DATA', {
          register: ym2151Mapper.getRegisterName(this.ym2151Register0),
          value
        });/**/
  ...
  _hardwareRead(offset) {
    switch (offset) {
      ...
      case soundMapper.ADDRESS_YM2151_REGISTER:
      console.log('read ADDRESS_YM2151_REGISTER');
