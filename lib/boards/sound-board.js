...
class SoundBoard {
  ...
  executeCycle(ticksToRun = 500, tickSteps = 4) {
    ...
    console.log('this.ym2151.Count(1024)',this.ym2151.Count(1024));
  ...
  _hardwareWrite(offset, value) {
    switch (offset) {
      ...
      case soundMapper.ADDRESS_WPC_LATCH_WRITE:
        ...
        //TODO IMPL!
        console.log('ADDRESS_WPC_LATCH_WRITE', value);
  ...
  _cpuWrite8(offset, value) {
    ...
    switch (address.subsystem) {
      ...
      case soundMapper.SUBSYSTEM_ROM:
        console.log('SUBSYSTEM_ROM__SND_INVALID_WRITE_SUBSYSTEM_0x', offset.toString(16), value);
        //SUBSYSTEM_ROM__SND_INVALID_WRITE_SUBSYSTEM_0x fb4e 153
        //SUBSYSTEM_ROM__SND_INVALID_WRITE_SUBSYSTEM_0x fb4f 157
        break;
  ...
  writeInterface(offset, value) {
    ...
    switch (offset) {
      ...
      case OP.WPC_SOUND_CONTROL_STATUS:
        ...
        console.log('TODO should reset cpu here!');
