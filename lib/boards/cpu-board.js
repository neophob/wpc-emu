...
class WpcCpuBoard {
  ...
  setState(stateObject) {
    ...
    //TODO this.soundBoard.setState(stateObject.asic.sound);
  }
  ...
  registerSoundBoardPlayIdCallback(playbackIdCallback) {
    this.soundBoard.registerSoundBoardPlayIdCallback(playbackIdCallback);
  }
