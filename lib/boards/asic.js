...
class CpuBoardAsic {
  ...
  reset() {
    ...
    this.midnightModeEnabled = false;
    this.blankSignalHigh = true;
    this.watchdogCount = 64;
    this.ticksWatchdog = 0;
  }
  ...
  executeCycle(ticksExecuted) {
    ...
    this.ticksWatchdog += ticksExecuted;
    if (this.ticksWatchdog >= 31) {
      this.ticksWatchdog -= 31;
      this.watchdogCount--;
      //console.log('this.watchdogCount', this.watchdogCount);
