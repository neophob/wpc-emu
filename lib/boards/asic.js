...
const securityPic = require('./elements/security-pic');
...
/*
define w15 - w18
  GERMANY: 124 aka 0111 1100b
  EXPORT: 172 aka 1010 1100b
  SPAIN: 236 aka 1110 1100b
  USA: 252 aka 1111 1100b
*/
//TODO jumper settings are different for wpc and wpc-s machines
const JUMPER_SETTINGS = 252;
...
class CpuBoardAsic {
  constructor(initObject) {
    ...
    this.hardwareHasPic = initObject.romObject && initObject.romObject.hasSecurityPic;
    ...
    switch (offset) {
      ...
      case OP.WPC_SWITCH_ROW_SELECT:
        if (this.hardwareHasPic) {
          ...
          const a = this.securityPic.read((col) => {
            return this.inputSwitchMatrix.getRow(col);
          });
          if (a!==0 && a>0xff) console.log('this.securityPic.read',a);
          return a;
        }
