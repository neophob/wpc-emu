...
class WebWorkerApi {
   ...
   * @param {number} framerate - optional parameter, default is 60fps
   */
  registerUiUpdateConsumer(callbackFunction, optionalInitialFramerate) {
    this.uiUpdateConsumerCallback = callbackFunction;
    if (!optionalInitialFramerate) {
      return Promise.resolve();
    }
    return this.adjustFramerate(optionalInitialFramerate);
  }
