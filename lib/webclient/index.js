...
class WebWorkerApi {
   ...
   * @param {*} block blocks further modifying of this memory location. you need to write to the same memory location with a disabled lock to unlock the memory again!
   */
  writeMemory(offset, value, block = false) {
    return this._sendMessage([ MESSAGE.writeMemory, offset, value, block ]);
  }
