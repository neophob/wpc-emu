...
class WpcAsic {
  ...
  constructor(romObject, interruptCallback) {
    ...
    this.dmd = BoardDotMatrix.getInstance(interruptCallback);
  }
...
The periodic interrupt can be disabled/enabled by writing to the ASIC's WPC_ZEROCROSS_IRQ_CLEAR
