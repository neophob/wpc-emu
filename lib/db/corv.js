module.exports = {
  ...
  memoryPosition: {
    knownValues: [
      ...
      { offset: 0x1731, name: 'GAME_SCORE_P1', description: 'Player 1 Score', type: 'bcd', length: 5 },
      { offset: 0x1737, name: 'GAME_SCORE_P2', description: 'Player 2 Score', type: 'bcd', length: 5 },
      { offset: 0x173D, name: 'GAME_SCORE_P3', description: 'Player 3 Score', type: 'bcd', length: 5 },
      { offset: 0x1743, name: 'GAME_SCORE_P4', description: 'Player 4 Score', type: 'bcd', length: 5 },
      ...
      { offset: 0x1D33, name: 'HISCORE_1_NAME', type: 'string' },
      { offset: 0x1D37, name: 'HISCORE_1_SCORE', type: 'bcd', length: 5 },
      { offset: 0x1D3C, name: 'HISCORE_2_NAME', type: 'string' },
      { offset: 0x1D40, name: 'HISCORE_2_SCORE', type: 'bcd', length: 5 },
      { offset: 0x1D45, name: 'HISCORE_3_NAME', type: 'string' },
      { offset: 0x1D49, name: 'HISCORE_3_SCORE', type: 'bcd', length: 5 },
      { offset: 0x1D4E, name: 'HISCORE_4_NAME', type: 'string' },
      { offset: 0x1D52, name: 'HISCORE_4_SCORE', type: 'bcd', length: 5 },
      { offset: 0x1D59, name: 'HISCORE_CHAMP_NAME', description: 'Grand Champion', type: 'string' },
      { offset: 0x1D5D, name: 'HISCORE_CHAMP_SCORE', description: 'Grand Champion', type: 'bcd', length: 5 },
    ]
  }
};
