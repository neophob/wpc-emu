    ...
    switch (mode) {
      ...
      case 6: //indexed, postbyte etc.
          ...
          if (!(pb & 0x80)) {
              ...
              params = toHexN(disp,1)+','+ixr;
              if (params[1] === '-') {
                // make sure we display negative hex values as mame
                params = '-$'+Math.abs(disp)+','+ixr;
              }
              break;
          }
          var ind = pb & 0x10;
          ...
          if (!ind) {
              switch (mod) {
                  ...
                  case 7: params ="???"; break;
                  case 8:
                    params = toHex2(ofs8) + ',' + ixr;
                    bytes++;
                    break;
                  case 9:
                    params = toHex4(ofs16)+","+ixr;
                    bytes+=2;
                    break;
