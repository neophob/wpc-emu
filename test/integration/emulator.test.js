...
test.serial('Smoketest, run emulator with rom ft20_32.rom', (t) => {
  ...
  t.is(uiState.asic.dmd.scanline, 25);
  ...
  t.is(uiState.asic.wpc.diagnosticLedToggleCount, 230);
  console.log('ticks', uiState.cpuState.tickCount);
  const ticksInRange = uiState.cpuState.tickCount > 33000000 && uiState.cpuState.tickCount < 34000000;
