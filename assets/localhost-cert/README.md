...
- use a bash shell (fish shell does not work for all commands)
...
- `openssl x509 -req -in server.csr -CA rootCA.pem -CAkey rootCA.key -CAcreateserial -out server.crt -days 700 -sha256 -extfile v3.ext`
