...
module.exports = {
  ...
  audio: {
    ...
    sample: {
      ...
      81: { channel: 1, sample: 'snd81' },
      81: { channel: 1, sample: 'snd81' },
      83: { channel: 1, sample: 'snd83' },
      83: { channel: 1, sample: 'snd83' },
      83: { channel: 1, sample: 'snd83' },
      84: { channel: 1, sample: 'snd84' },
      84: { channel: 1, sample: 'snd84' },
      87: { channel: 1, sample: 'snd87' },
      87: { channel: 1, sample: 'snd87' },
      88: { channel: 1, sample: 'snd88' },
      88: { channel: 1, sample: 'snd88' },
      88: { channel: 1, sample: 'snd88' },
      136: { channel: 1, sample: 'snd136' },
      137: { channel: 1, sample: 'snd137' },
      137: { channel: 1, sample: 'snd137' },
      137: { channel: 1, sample: 'snd137' },
      137: { channel: 1, sample: 'snd137' },
      137: { channel: 1, sample: 'snd137' },
      161: { channel: 1, sample: 'snd161' },
      162: { channel: 1, sample: 'snd162' },
      163: { channel: 1, sample: 'snd163' },
      164: { channel: 1, sample: 'snd164' },
      165: { channel: 1, sample: 'snd165' },
      165: { channel: 1, sample: 'snd165' },
      165: { channel: 1, sample: 'snd165' },
      178: { channel: 1, sample: 'snd178' },
      185: { channel: 1, sample: 'snd185' },
  ...
  memoryPosition: {
    ...
    knownValues: [
      ...
      { offset: 0x481, name: 'GAME_CURRENT_SCREEN', description: '0x00: attract mode, 0x01: game play/system menu, 0x80: tilt warning, 0xF1: credits view', type: 'uint8' },
      ...
      { offset: 0x1794, name: 'GAME_PLAYER_TOTAL', description: '1-4 players', type: 'uint8' },
