...
module.exports = {
  ...
  memoryPosition: {
    checksum: [
      { dataStartOffset: 0x1C61, dataEndOffset: 0x1C80, checksumOffset: 0x1C81, checksum: '16bit', name: 'HIGHSCORE' },
    ],
    knownValues: [
      { offset: 0x7A, name: 'GAME_RUN', description: '0: not running, 1: running', type: 'uint8' },
