...
module.exports = {
  ...
  memoryPosition: {
    checksum: [
      ...
      { dataStartOffset: 0x1B98, dataEndOffset: 0x1C7A, checksumOffset: 0x1C7B, checksum: '16bit', name: 'ADJUSTMENT' },
    ],
    knownValues: [
      ...
      { offset: 0x579, name: 'GAME_ATTRACTMODE_SEQ', description: 'Game specific sequence of attract mode, could be used to skip some screens', type: 'uint8' },
